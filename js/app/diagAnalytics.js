...
$(function () {
    ...
    var labels = [],
        data = [];
    $("#dataDiagramm tfoot th").each(function () {
        labels.push($(this).html());
    });
    $("#dataDiagramm tbody td").each(function () {
        data.push($(this).html());
    });
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[1].attr({text: lbl + localStorage["strtmp"]}).show().stop().animateWith(frame, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible);
                dot.attr("r", 6);
